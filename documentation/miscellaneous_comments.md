- Path to the full sky CosmoGrid maps with DES Y3 redshift bins
  ...
  - transfer to Euler scratch `sbatch -n 1 --cpus-per-task=1 --time=4:00:00 --mem-per-cpu=1024 --wrap="rsync -ahv athomsen@login.phys.ethz.ch:/home/ipa/refreg/experiments/tomaszk/projects/220627_cosmogrid_desy3/001_perms/cosmogrid_desy3/CosmoGrid/DESY3/fiducial /cluster/scratch/athomsen/CosmoGrid"`
