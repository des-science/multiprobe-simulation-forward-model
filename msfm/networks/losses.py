...
def delta_loss(predictions, n_params, n_same, off_sets, n_output=None, jac_weight=0.0, force_params=None,
               ...
               img_summary=False, cov_weight=False):
    """
    ...
    :param cov_weight: If true, the jac weight will be used as cov_weight, i.e. loss cov mat will be forced to be
                       close to the identity matrix. Note that there will be an additional term forcing the inverse
                       of the covariance to be close to the identity as well since the cov is guaranteed to be square.
                       This is the same as Luca's regularization term, but without the adaptive weight.
